...
const Services = () => {
    ...
    return (
        ...
        <section className="services-hero"></section>
            ...
            <div className="  border-b-2 border-orangeRed py-4 w-100 " >
                <div className=" container py-2 mx-auto px-6" >
                    <div className="   grid  gap-3 grid-cols-1    md:grid-cols-2 pt-4 items-center   ">
                        ...
                        <div className="left py-2  " data-aos="slide-right">
                            ...
                            <h2 className="text-greyBlack font-bold  text-4xl"> OUR SERVICES
                            </h2>

                            <p className="text-base  border-orangeRed rounded-md border-l-2  text-greyBlack  ps-3  font-md pt-4  ">In a world where excellence is the standard, we rise above and beyond. Our mission is to transform your aspirations into reality, delivering unparalleled solutions that exceed expectations. With unwavering dedication and a commitment to innovation, we're here to guide you on your journey towards success. Explore our services and experience a new dimension of excellence today</p>
