const Service = [
...

    {
        ...
        Info: " Legacies are not built overnight; they are carefully woven through dedication and impact. We are dedicated to preserving and honoring legacies of Real Estate Icons. Through rich storytelling, we chronicle their journey from vision to reality, showcasing how these icons have left indelible marks on the industry and the communities they served."
...

    {
        ...
        Info: " Every industry has her trailblazers. At 50 REIN, we unveil the visionaries who’ve blazed new paths within the real estate landscape. Through comprehensive profiling, we showcase the bold decisions, innovative disruptions, and transformative projects that have propelled these icons to the forefront of the industry."
