...
const Team = () => {
    ...
    return(
        <div className=" shadow-md px-4 hover:scale-110  hover:bg-blue-50 transition  duration-500 " data-aos="zoom-in-up" key={index}>
        <div className=" py-6  ">
            ...
            <div className="flex flex-col justify-center items-center py-2 ">
                <div className="flex flex-col  items-center">
                    <p className="text-l font-bold text-darkBlue  pt-3 ">
                       {team.Name}  </p>
                    <p className="text-[14px]  text-gray-600   pt-1 pb-3 font-thin ">
                        {team.Position} </p>
                </div>
